...
default_args = {
    'kernel_config': ['a'],
    'max_norm_h2': numpy.array([0.3]),
    'max_norm_h3': numpy.array([1.0]),
    'max_norm_y': numpy.array([0.2]),
    'l_ir_h2': numpy.array([-1.2273]),
    'l_ir_h3': numpy.array([-0.7247]),
    'l_ir_y': numpy.array([-7]),
    'log_init_learning_rate': numpy.array([-4.5115])
}
...
def main(job_id, requested_params, cache):
    ...
    if params['kernel_config'][0] == 'a':
        ...
        output_channels_h2 = int(1.00 * 70)
        output_channels_h3 = int(3.47 * 70)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--savelast', action='store_true', help='save last state as well')
